...
export const STAGE_CARDS: StageCardDef[] = [
  {
    ...
    description:
      "감정을 직설적으로 던지는 가사처럼, 버프·디버프·회복이 더 진하게 걸린다. " +
  ...
  },
  {
    ...
    nameKo: "긴 이야기 — 하치",
    description:
      "서사적인 곡답게 판 자체가 길어지고 설치형 카드가 오래 남는다. " +
  ...
  },
  {
    ...
    description:
      "쉴 새 없이 몰아치는 초기 보카로 록처럼, 한 턴에 곡을 두 곡까지 발매할 수 있다. " +
  ...
  },
  {
    ...
    nameKo: "생각이 많은 밤 — 이요와",
    description:
      "머릿속을 가득 채우는 상념들처럼 카드가 잘 돌지만, 다 붙잡고 있을 수는 없다. " +
  ...
  },
  {
    ...
    description:
      "K-POP 무대 같은 고에너지 하이텐션. 한 방이 크지만 오래 버티긴 어렵다. " +
  ...
  },
  {
    ...
    nameKo: "윤회의 밤 — 50mang",
    description:
      "한국 설화 속 존재들처럼, 한 번 쓰러진 곡도 다시 돌아온다. " +
