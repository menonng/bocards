...
export const SONG_CARDS = [
    ...
    // ── 추가곡 (2026-08 요청분) — P카드 소속과 무관한 게스트 프로듀서 포함.
    // isMyth/youtube100M은 개별 조사로 확인된 것만 표시했다(추정 금지 원칙 유지).
    // 예: 命に嫌われている。는 니코니코 "전설입성"(100만)까지만 확인되어 isMyth
    // (=니코니코 신화입성, 1000만) 조건을 충족하지 않는다.
    {
        id: "balloon-charles",
